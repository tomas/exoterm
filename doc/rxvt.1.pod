...
Compile frills: Disables (or enabled) emitting bracketed paste mode
...
sequences will no longer be omitted. You can also toggle this from the
...
Prevents emission of paste bracket sequences; option B<-dpb>.
